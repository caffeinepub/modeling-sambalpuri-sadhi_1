...
import type { ExternalBlob as _ExternalBlob, SareeListing as _SareeListing, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createSareeListing(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: boolean, arg5: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createSareeListing(arg0, arg1, arg2, arg3, arg4, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteSareeListing(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteSareeListing(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSareeListings(): Promise<Array<SareeListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSareeListings();
    ...
    async getAvailableSareeListings(): Promise<Array<SareeListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableSareeListings();
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSareeById(arg0: string): Promise<SareeListing> {
        if (this.processError) {
            try {
                const result = await this.actor.getSareeById(arg0);
                return from_candid_SareeListing_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getSellerPhoneNumber(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getSellerPhoneNumber();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setSellerPhoneNumber(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setSellerPhoneNumber(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSareeListing(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: boolean, arg5: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSareeListing(arg0, arg1, arg2, arg3, arg4, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_SareeListing_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SareeListing): Promise<SareeListing> {
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SareeListing>): Promise<Array<SareeListing>> {
    return await Promise.all(value.map(async (x)=>await from_candid_SareeListing_n12(_uploadFile, _downloadFile, x)));
}
